<div class="document">
    ...
    @else
        <a href="{{ $document->url }}" target="_blank" class="document-title">
            <i class="fa-regular fa-file-pdf"></i> {{ $document->titre }}
        </a>
        @if ($document->category->module->enseignant == Auth::id())
            <div class="document-actions">
                ...
                <abbr title="supprimer">
                    <button class="document-action" wire:click.prevent="delete()">
